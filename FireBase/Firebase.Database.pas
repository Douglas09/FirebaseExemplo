...
type
  ...
  public
    ...
    function Put2(AJson: string): String;
    function SetSite(const AParams: array of string; AData: TJSONValue = nil;
      AQueryParams: TDictionary<string, string> = nil;
      ADataOwner: boolean = true): IFirebaseResponse;
...
function TFirebaseDatabase.SetSite(const AParams: array of string; AData: TJSONValue; AQueryParams: TDictionary<string, string>; ADataOwner: boolean): IFirebaseResponse;
var
...
function TFirebaseDatabase.Post(const AParams: array of string; AData: TJSONValue = nil; AQueryParams: TDictionary<string, string> = nil; ADataOwner: boolean = true): IFirebaseResponse;
var
  ARequest: IFirebaseRequest;
begin
  ARequest := TFirebaseRequest.Create(BaseURI, Token);
...
function TFirebaseDatabase.Put2(AJson: string): String;
var AResponseContent, lJsonStream: TStringStream;
    lIdHTTP : THTTPClient;
    lResponse: string;
begin
  result := '';
  try
    ...
    lIdHTTP.Put(BaseURI+ '.json', lJsonStream, AResponseContent);
    result := AResponseContent.DataString;
  except end;
  lIdHTTP.DisposeOf;
  AResponseContent.DisposeOf;
